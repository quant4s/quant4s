...
trait TradeAccountService extends HttpService {
  ...
  // TODO: 这里用路径名 替换了 TradeRouteActor.path, 需要订正
  val traderManager = actorRefFactory.actorSelection("/user/traderRouter")
 ...
 *
  ...
  private def _reconnect(id: Int): String = {
    ...
    // TODO:
    val tradeAccountRef = actorRefFactory.actorSelection("/user/traderRouter/" + id.toString)
